function out         = nll_gauss_shiftC(freeParam, model, data)

if strcmp(model.mode, 'initialize')

    out.paraID     = {'\mu','\sigma','c1_{pre}','dc_{post,1}','dc_{post,2}','dc_{post,3}','dc_{post,4}','dc_{post,5}','dc_{post,6}','dc_{post,7}','dc_{post,8}','dc_{post,9}','\lambda'};
    ...
    sigma = freeParam(2);
    c_pre = freeParam(3);
    dc_post1 = freeParam(4);
    dc_post2 = freeParam(5);
    dc_post3 = freeParam(6);
    dc_post4 = freeParam(7);
    dc_post5 = freeParam(8);
    dc_post6 = freeParam(9);
    dc_post7 = freeParam(10);
    dc_post8 = freeParam(11);
    dc_post9 = freeParam(12);
    lambda = freeParam(13);
