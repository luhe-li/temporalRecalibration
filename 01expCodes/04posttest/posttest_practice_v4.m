%% post-exposure phase practice: top-up re-exposure + ternary TOJ task
...
% In this practice, each of the SOAs will be presented 1 time, resulting in
% only 15 trials. 
...
%     ExpInfo.deviceIndices = [0, 1, 0]; % use internal display, speaker, keyboard;
    ...
    out1FileName                             = ['practice_posttest_sub', num2str(ExpInfo.subjID) '_session' num2str(ExpInfo.session)]; %create file name
