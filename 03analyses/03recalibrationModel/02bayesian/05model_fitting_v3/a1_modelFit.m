...
addpath('/Users/luheli/Documents/GitHub/bads')

all_sub = 1:1;
all_ses = 1:1;

for include_pre_mu = 0:1

    if include_pre_mu == 1
        flnm = 'a1_modelFit_results_y_pre_mu';
    else
        flnm = 'a1_modelFit_results_n_pre_mu';
    end
    ...
    for sub = all_sub
        for  ses = all_ses
            ...
            funcNLL = @(p) cal_nLL_CI(p(1), p(2), p(3), p(4), p(5), p(6), p(7), ...
                p(8), p(9), p(10), p(11), model(sub, ses), data(sub, ses), include_pre_mu);
            ...
            %                 p(8), p(9), p(10), p(11), model, data, include_pre_mu);
            %         end
