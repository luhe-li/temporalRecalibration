...
function [R2, aR2] = model_comp_gof_v3(subjID, sess, idxBestModel, bestP)
...
M5 = {@(p) P_Vfirst(pre_ms_unique, p(1), p(2), p(3), p(5));...
    @(p) P_simultaneous(pre_ms_unique, p(1), p(2), p(3), p(5));...
    @(p) P_Afirst(pre_ms_unique, p(1), p(2), p(3), p(5));...
    @(p) P_Vfirst(pre_ms_unique, p(1), p(2), p(4), p(6));...
    @(p) P_simultaneous(pre_ms_unique, p(1), p(2), p(4), p(6));...
    @(p) P_Afirst(pre_ms_unique, p(1), p(2), p(4), p(6))};

M6 = {@(p) P_Vfirst(pre_ms_unique, p(1), p(2), p(3), p(4));...
