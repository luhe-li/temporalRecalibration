function model_comp_plotting(subjID, sess, idxBestModel, bestP)
...
M1 = {@(p) P_Afirst(SOA_finer, p(1), p(3), p(5), p(7));...
    ...
    @(p) P_Afirst(SOA_finer, p(2), p(4), p(6), p(7));...
    @(p) P_Vfirst(SOA_finer, p(2), p(4), p(6), p(7));...
    @(p) P_simultaneous(SOA_finer, p(2), p(4), p(6), p(7))};

M2 = {@(p) P_Afirst(SOA_finer, p(1), p(3), p(5), p(6));...
    @(p) P_Vfirst(SOA_finer, p(1), p(3), p(5), p(6));...
    @(p) P_simultaneous(SOA_finer, p(1), p(3), p(5), p(6));...
    @(p) P_Afirst(SOA_finer, p(2), p(3), p(5), p(6));...
    @(p) P_Vfirst(SOA_finer, p(2), p(3), p(5), p(6));...
    @(p) P_simultaneous(SOA_finer, p(2), p(3), p(5), p(6))};

M3 = {@(p) P_Afirst(SOA_finer, p(1), p(3), p(5), p(6));...
    @(p) P_Vfirst(SOA_finer, p(1), p(3), p(5), p(6));...
    @(p) P_simultaneous(SOA_finer, p(1), p(3), p(5), p(6));...
    @(p) P_Afirst(SOA_finer, p(2), p(4), p(5), p(6));...
    @(p) P_Vfirst(SOA_finer, p(2), p(4), p(5), p(6));...
    @(p) P_simultaneous(SOA_finer, p(2), p(4), p(5), p(6))};

M4 = {@(p) P_Afirst(SOA_finer, p(1), p(3), p(4), p(5));...
    @(p) P_Vfirst(SOA_finer, p(1), p(3), p(4), p(5));...
    @(p) P_simultaneous(SOA_finer, p(1), p(3), p(4), p(5));...
    @(p) P_Afirst(SOA_finer, p(2), p(3), p(4), p(5));...
    @(p) P_Vfirst(SOA_finer, p(2), p(3), p(4), p(5));...
    @(p) P_simultaneous(SOA_finer, p(2), p(3), p(4), p(5))};
