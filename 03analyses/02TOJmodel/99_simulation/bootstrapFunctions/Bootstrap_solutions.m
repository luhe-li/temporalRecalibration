...
function [estP_btst, minNLL, lb_95CI, ub_95CI] = Bootstrap_solutions(s_unique, r_org, nT,...
    numBtst, Ptilde, lb, ub, options) 
...
for i = 1:numBtst
    ...
    nLL = @(p) -nT_V1st_slc*log(Ptilde(p(1), p(2), p(3), s_unique))' -...
            (nT - nT_V1st_slc)*log(1-Ptilde(p(1), p(2), p(3), s_unique))';
