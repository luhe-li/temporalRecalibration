function [deltaAIC, estP] = model_comp_fitting(subjID)
...
n_init = 10;
numP     = [7,6,6,5,4]; %number of free parameters for M1, M2, M3, M4, M5 respectively

%define upper and lower bounds
lb       = {[-150, -150, 10, 10, 50, 50, 0.01], ...%M1
    [-150, -150, 10, 1, 1, 0.01] ...%M2
    [-150, -150, 10, 10, 1, 0.01], ...%M3
    [-150, -150, 10, 1, 0.01], ...%M4
    [-150, 10, 1, 0.01]};%M5
ub       = {[150, 150, 350, 350, 400, 400, 0.06], ...%M1
    [150, 150, 350, 400, 400, 0.06], ...%M2
    [150, 150, 350, 350, 400, 0.06], ...%M3
    [150, 150, 350, 400, 0.06], ...%M4
    [150, 350, 400, 0.06]};%M5
...
for sess = 1:9
    ...
    M1 = @(p) -pre_nT_A1st*log(P_Afirst(pre_ms_unique, p(1), p(3), p(5), p(7)))'...
        ...
        -post_nT_A1st*log(P_Afirst(post_ms_unique, p(2), p(4), p(6), p(7)))' ...
        -post_nT_V1st*log(P_Vfirst(post_ms_unique, p(2), p(4), p(6), p(7)))'...
        -post_nT_simul*log(P_simultaneous(post_ms_unique, p(2), p(4), p(6), p(7)))';
    ...
    M2 =  @(p) -pre_nT_A1st*log(P_Afirst(pre_ms_unique, p(1), p(3), p(4), p(6)))' ...
        ...
        -post_nT_A1st*log(P_Afirst(post_ms_unique, p(2), p(3), p(5), p(6)))' ...
        -post_nT_V1st*log(P_Vfirst(post_ms_unique, p(2), p(3), p(5), p(6)))'...
        -post_nT_simul*log(P_simultaneous(post_ms_unique, p(2), p(3), p(5), p(6)))';
    ...
    M3 = @(p) -pre_nT_A1st*log(P_Afirst(pre_ms_unique, p(1), p(3), p(5), p(6)))' ...
        ...
        -post_nT_A1st*log(P_Afirst(post_ms_unique, p(2), p(4), p(5), p(6)))' ...
        -post_nT_V1st*log(P_Vfirst(post_ms_unique, p(2), p(4), p(5), p(6)))'...
        -post_nT_simul*log(P_simultaneous(post_ms_unique, p(2), p(4), p(5), p(6)))';...
    ...
    M4 = @(p) -pre_nT_A1st*log(P_Afirst(pre_ms_unique, p(1), p(3), p(4), p(5)))' ...
        ...
        -post_nT_A1st*log(P_Afirst(post_ms_unique, p(2), p(3), p(4), p(5)))' ...
        -post_nT_V1st*log(P_Vfirst(post_ms_unique, p(2), p(3), p(4), p(5)))'...
        -post_nT_simul*log(P_simultaneous(post_ms_unique, p(2), p(3), p(4), p(5)))';
    ...
    M5 = @(p) -pre_nT_A1st*log(P_Afirst(pre_ms_unique, p(1), p(2), p(3), p(4)))' ...
        ...
        -post_nT_A1st*log(P_Afirst(post_ms_unique, p(1), p(2), p(3), p(4)))' ...
        -post_nT_V1st*log(P_Vfirst(post_ms_unique, p(1), p(2), p(3), p(4)))'...
        -post_nT_simul*log(P_simultaneous(post_ms_unique, p(1), p(2), p(3), p(4)))';
