function [deltaAIC, estP]     = model_recovery_fit_fake_data_v2(sim_r_org, ExpInfo)

% Model fitting and comparison for the fake data. Fake data are simulated by
...
for m                         = 1:numM %loop through models
    for ii                        = 1:n_init
