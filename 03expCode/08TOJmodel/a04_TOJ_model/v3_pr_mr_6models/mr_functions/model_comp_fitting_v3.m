function [deltaAIC, estP]     = model_comp_fitting_v3(subjID)

%Model comparison for ternary TOJ in the pre/post test across 9 sessions, for each individual
%Added criterion only model (M5), in total 6 models
...
estP                          = cell(9,numM); % 9 sessions x 6 models
[min_NLL, AIC]                = deal(NaN(9, numM)); % 9 sessions x 6 models
