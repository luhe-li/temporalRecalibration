...
%the levels of SOA
ifi = 1000/60;
s_unique = [-500, -300, -200, -100, -3*ifi, -2*ifi, -ifi, 0, ifi, 2*ifi, 3*ifi, 100, 200, 300, 500];
...
for t = 1:length(nTrials)
    f(t) = figure;
    g(t) = figure;
    reject = 0; % reset successful H0 rejection number for each simulated nTrial
...
%         figure; hold on
%         plot(s_unique, [sim_prob_Vfirst{t,1}';sim_prob_Afirst{t,1}';sim_prob_simul{t,1}'],'--o');
%         plot(s_unique, [sim_prob_Vfirst{t,2}';sim_prob_Afirst{t,2}';sim_prob_simul{t,2}'],'-o');
        ...
        lb = [ -150, -150, 30, 1e-2, 10];
        ub = [150, 150, 500, 0.06, 300];
