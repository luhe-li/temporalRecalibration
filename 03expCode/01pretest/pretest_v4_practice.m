%% pre-exposure practice: ternary temporal order judgement task
...
% (SOA), ranging from [-500, -300, -200, -100, -1/60*4, -1/60*2, 0, 1/60*2,
% 1/60*4, 100, 200, 300, 500] ms. A positive SOA refers to a visual lead
...
% In this practice session, each of the SOAs will be randomly interleaved
% within a method of a constant stimuli and presented 1 time, resulting in
...
%     ExpInfo.deviceIndices = [0, 1, 0]; % use internal display, speaker, keyboard;
    ...
    out1FileName                         = ['practice_pretest_sub', num2str(ExpInfo.subjID) '_session' num2str(ExpInfo.session)]; %create file name
