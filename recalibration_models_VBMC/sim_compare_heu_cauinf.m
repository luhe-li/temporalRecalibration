...
for i = 1:n_level
    ...
    p_afirst_lapse        = lambda/3 + (1-lambda).* expCDF(x_axis, beta, -criterion, i_tau_a, tau_v) + realmin;
    p_vfirst_lapse        = lambda/3 + (1-lambda).* (1 - expCDF(x_axis, beta, criterion, i_tau_a, tau_v))+ realmin;
