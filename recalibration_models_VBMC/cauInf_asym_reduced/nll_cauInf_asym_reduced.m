...
function out   = nll_cauInf_asym_reduced(freeParam, model, data)

if strcmp(model.mode, 'initialize')

    out.paraID   = {'\tau','\sigma_{A}','\sigma_{V}','c','\lambda','p_{common}','\alpha'};
    ...
    % fix prior width from modeling results of more complex models
    sigma_C1 = 50;
    sigma_C2 = 330;
