...
% (SOA), ranging from [-300:5;300] ms. A positive SOA refers
...
%     ExpInfo.deviceIndices = [0, 1, 0]; % use internal display, speaker, keyboard;
    ...
    ExpInfo.SOA = sort(repmat([100:50:300, 400]/1000,[1,10])); % s
% ExpInfo.SOA = [-400:50:400]/1000;
    ...
    ExpInfo.bias = 0.03253; % s, number obtained from oscilloscope
