...
%     ExpInfo.SOA = [-600, -400:50:400, 600]/1000; %s
 ExpInfo.SOA = [ -400:50:400, 600]/1000; %s
    ExpInfo.numSOA = 1;
%     ExpInfo.SOA = 600/1000;
%     ExpInfo.numSOA = length(ExpInfo.SOA);

    % trial number per SOA level
    ExpInfo.numTrials = 60;
...
%     ExpInfo.trialSOA = repmat(ExpInfo.SOA, [1, ExpInfo.numTotalTrials]);
...
%     [windowPtr,rect] = Screen('OpenWindow', ExpInfo.deviceIndices(1), [0,0,0],[100 100 1000 600]); % for testing
    ...
    AudInfo.Beep = [MakeBeep(AudInfo.tf, AudInfo.beepLengthSecs, AudInfo.fs);...
        zeros(1, AudInfo.beepLengthSecs * AudInfo.fs + 1)];
...
PsychPortAudio('Stop', pahandle);
    ...
    checkt = NaN(size(ExpInfo.trialSOA));
    for i = 1:ExpInfo.numTotalTrials
        ...
        checkt(i) =  PresentMultisensoryStimuliTestOscilloscope_v4(i,ExpInfo,ScreenInfo,...
