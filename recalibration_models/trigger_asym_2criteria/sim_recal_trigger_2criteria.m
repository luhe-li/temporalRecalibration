function tau_shift = sim_recal_trigger_2criteria(exp_trial, adaptor_soa, ...
...
for tt = 1:exp_trial
    ...
    % If the measurement is larger than the criterion of reporting
    % simutaneity, recalibrate auidovisual bias
    idx_update = (abs(soa_m) > criterion) & (abs(soa_m) < c_recal) & (~isnan(soa_m));
