function [out, out_sd] = nll_trigger_sym(freeParam, model, data)
...
if strcmp(model.mode, 'initialize')
    ...
    tau = freeParam(1);
    sigma_a = freeParam(2); % sigma_a = sigma_v
    sigma_v = freeParam(2); 
    ...
    if strcmp(model.mode, 'optimize')
        ...
        for t    = 1:model.expo_num_sim
            ...
            tau_shift(:, t)  = sim_recal_trigger(model.expo_num_trial, adaptor_soas, ...
    ...
    elseif strcmp(model.mode,'predict')
        ...
        for t    = 1:model.expo_num_sim
            ...
            out.tau_shift(:,t) = sim_recal_trigger(model.expo_num_trial, out.adaptor_soa, ...
                tau, sigma_a, sigma_v, criterion, alpha);
